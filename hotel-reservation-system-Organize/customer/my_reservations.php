                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td>
                                <span class="status-badge status-<?php echo strtolower(htmlspecialchars($row['reservation_status'])); ?>">
                                    <?php echo htmlspecialchars($row['reservation_status']); ?>
                                </span>
                            </td>
                            <td>
                                <?php if ($row['reservation_status'] == "Pending") { ?>
                                    <a href="edit_reservations.php?id=<?php echo (int)$row['reservation_id']; ?>">Edit</a>
                                    |
                                    <a href="cancel_reservations.php?id=<?php echo (int)$row['reservation_id']; ?>"
